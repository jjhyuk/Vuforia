...
/// </summary>
public class bandTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        if (mTrackableBehaviour.gameObject.GetComponentInChildren<AudioSource>() != null)
        {
            ...
            mTrackableBehaviour.gameObject.GetComponentInChildren<AudioSource>().volume = 1;
    ...
    protected virtual void OnTrackingLost()
    {
        ...
        if (mTrackableBehaviour.gameObject.GetComponentInChildren<AudioSource>() != null)
        {
            ...
            mTrackableBehaviour.gameObject.GetComponentInChildren<AudioSource>().volume = 0;
